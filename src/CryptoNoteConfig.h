...
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 50000000;
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE     = 10000 / DIFFICULTY_TARGET - alreadyGeneratedCoins; //size of block (bytes) after which reward for block calculated using block size
const size_t   CRYPTONOTE_COINBASE_BLOB_RESERVED_SIZE        = 900;
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        =  20 * DIFFICULTY_TARGET;
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_NUMERATOR         = 100 * DIFFICULTY_TARGET;
...
const char     CRYPTONOTE_NAME[]                             = "BitAltearning";
...
const std::initializer_list<const char*> SEED_NODES = {
  //"node1.bitaltearning.com:7700",
  //"node2.bitaltearning.com:7700",
};
